...
my_score is 85
my_score is my_score + 5   Note :  Now it's 90!`} 
            />
          </SubSection>
        </DocSection>
      )
...
say_hello()
result is add_numbers(5, 3)   Note :  Gets 8`} 
            />
          </SubSection>
        </DocSection>
      )
...
my_pet.make_sound("Meow!")   Note :  Shows: Fluffy the cat says: Meow!`} 
            />
          </SubSection>
        </DocSection>
      )
...
.`} 
  ...
  sum is 5 + 3        Note :  Gets 8
  
  Note :  Subtracting
  difference is 10 - 4  Note :  Gets 6
  
  Note :  Multiplying
  product is 6 * 2     Note :  Gets 12
  ...
  a equals b       Note :  Checks if a equals b
  
  Note :  Is it different?
  a not equals b   Note :  Checks if a is different from b
  
  Note :  Which one is bigger?
  a > b           Note :  Is a bigger than b?
  a >= b          Note :  Is a bigger or equal to b?
  
  Note :  Which one is smaller?
  a < b           Note :  Is a smaller than b?
  a <= b          Note :  Is a smaller or equal to b?`} 
              />
            </SubSection>
          </DocSection>
        )
  ...
  Note :  Getting values
  name is Name of player      Note :  Gets "Alex"
  health is Health of player  Note :  Gets 100
  
  Note :  Changing values
  Health of player is 90      Note :  Updates health to 90

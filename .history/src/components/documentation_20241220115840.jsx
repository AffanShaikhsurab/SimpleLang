...
import { ChevronDown, ChevronRight, Play, Layout , Book, Terminal , Code, Box, Search, Menu, X, ArrowRight } from 'lucide-react';
...
const FeatureCard = ({ icon: Icon, title, description }) => (
    <div className="relative p-4 backdrop-blur-sm bg-white/20 rounded-lg border border-white/10 hover:bg-white/30 transition-all duration-300">
  ...
  const DocSection = ({ title, description, children }) => (
    <div className="relative mb-16 rounded-xl overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-8 p-8">
        {/* Left side - Enhanced description section */}
        <div className="lg:w-1/3 space-y-6">
          <div className="relative backdrop-blur-lg bg-white/40 p-6 rounded-xl border border-white/20 shadow-xl">
            ...
            <div className="space-y-4 mt-8">
              <FeatureCard 
                ...
                description="Detailed documentation with practical examples and best practices."
              />
              <FeatureCard 
                icon={Code}
                title="Clean Code"
                description="Well-structured, maintainable, and thoroughly tested codebase."
              />
              <FeatureCard 
                icon={Terminal}
                title="CLI Support"
                description="Powerful command-line interface for advanced automation."
              />
              <FeatureCard 
                icon={Layout}
                title="Modern UI"
                description="Beautiful, responsive interfaces with glassmorphic design."
              />
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-2/3 relative backdrop-blur-lg bg-white/40 p-6 rounded-xl border border-white/20 shadow-xl">

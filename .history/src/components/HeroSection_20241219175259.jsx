...
const HeroSection = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#" className="text-gray-600 hover:text-gray-900">Our work</a>
              <a href="#" className="text-gray-600 hover:text-gray-900">About us</a>
              <a href="#" className="text-gray-600 hover:text-gray-900">Team</a>
            </div>
            <button className="bg-gray-900 text-white px-4 py-2 rounded-full flex items-center space-x-2">
              <span>Sign in</span>
      ...
      {/* Stats */}
      <div className="absolute top-32 right-8 lg:right-16">
      ...
      {/* Code Preview */}
      <div className="hidden lg:block absolute right-16 top-64 w-96">
        ...
        <div className="mt-4 bg-white p-4 rounded-lg shadow-lg">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">iOS Developer</div>
            </div>
          </div>

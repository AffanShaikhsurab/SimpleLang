...
const HeroSection = () => (
  <div className="relative min-h-screen bg-gradient-to-br from-purple-400 via-pink-300 to-yellow-200">
    <div className="container mx-auto pt-20 px-12">
      <div className="max-w-2xl">
        ...
        <div className="flex space-x-4">
          <button className="bg-black text-white px-8 py-3 rounded text-sm shadow-lg hover:bg-gray-800">
            Learn more
          </button>
          <button className="flex items-center space-x-2 px-8 py-3 text-sm bg-white shadow-md rounded border border-gray-300 hover:bg-gray-100">
  ...
  text-transform: uppercase;
      ...
      <div className="flex justify-end space-x-12 mt-8">
        <div className="text-center">
          <div className="text-4xl font-bold text-purple-600">546</div>
          <div className="text-sm text-gray-600">courses</div>
        </div>
        <div className="text-center">
          <div className="text-4xl font-bold text-purple-600">685</div>
          <div className="text-sm text-gray-600">mentors</div>
        </div>
      </div>

      <div className="mt-8 bg-white p-4 rounded-lg shadow-md max-w-xs">
        <div className="flex items-center space-x-3">
          <img src="/api/placeholder/40/40" alt="David Alexandrov" className="rounded-full shadow-sm" />
          <div>
    ...
    <div className="absolute bottom-0 w-full border-t border-gray-200 bg-white/80 backdrop-blur-sm">
      <div className="container mx-auto px-12 py-6 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          <div className="w-8 h-8 bg-black text-white rounded-full flex items-center justify-center font-medium shadow-md">
            1
          </div>

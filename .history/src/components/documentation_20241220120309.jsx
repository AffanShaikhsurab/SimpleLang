  ...
  return (
    ...
    <div className="relative mb-8 md:mb-16 px-4 md:px-8 py-6 md:py-10 shadow-lg rounded-xl overflow-hidden bg-white/80 border border-white/20">
      ...
      <div className="relative z-10">
        <h2 className="text-2xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 md:bg-clip-text md:text-transparent md:bg-gradient-to-r md:from-gray-900 md:to-gray-600 text-gray-900">
          {title}
        </h2>
        {description && (

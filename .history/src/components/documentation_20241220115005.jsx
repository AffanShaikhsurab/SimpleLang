...
const DocSection = ({ title, description, children }) => (
  ...
  const CodeExample = ({ code, title }) => (
    <div className="rounded-lg overflow-hidden shadow-md border border-gray-300 my-6">
      ...
      <div className="p-6 bg-gray-900 text-gray-100 font-mono text-sm rounded-b-lg">

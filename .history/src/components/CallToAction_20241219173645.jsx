...
import { ArrowRight } from 'lucide-react'; // Import only once
    ...
    >
      ...
      <div className="container mx-auto px-12 text-center relative z-10"> 
        <div className="max-w-2xl mx-auto"> 
          <section className="py-20 bg-gradient-to-br from-purple-50 to-purple-100"> {/* You probably don't need a nested section here */}
            <div className="container mx-auto px-12 text-center"> {/* And likely not a nested container either */}
              <div className="max-w-2xl mx-auto">
          ...
          </section> {/* Consider removing this closing tag along with the opening one above */}
        </div>
      </div>
    </section>
  );

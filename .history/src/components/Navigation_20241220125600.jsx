...
const Navigation = ({ showDocs, setShowDocs }) => {
  ...
  return (
    <nav className="border-b border-gray-200">
      ...
      <div className="flex items-center justify-between p-4 md:p-0 bg-white">
        ...
        <div className="flex items-center">
          <img
            ...
            alt="SimplyLang Logo"
            className="w-12 h-12 md:w-16 md:h-16 object-contain" // You can adjust the size as needed
          />
        </div>
      ...
      {/* Navigation Links */}
      <div
        className={`flex-col md:flex md:flex-row md:items-center ${isMenuOpen ? "flex" : "hidden"}`}
      >
        {/* Home Link */}
        <a
          href="#"
